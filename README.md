...
| [`Path.cwd()`](https://docs.python.org/3/library/pathlib.html#pathlib.Path.cwd)                 | [`path.Cwd()`](https://github.com/rewgs/go-pathlib/blob/main/path/funcs.go#22)      |  finished   |     todo      |
